...
normalized_features = [
    'normalizedAvgPrice', 'normalizedLow', 'normalizedHigh',
    'normalizedOpen', 'normalizedRange'
]

normalized_features = [feat for feat in normalized_features if feat in data.columns]

X = data[normalized_features]
y = data['normalizedClose']  
